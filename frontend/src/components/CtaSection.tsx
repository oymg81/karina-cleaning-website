...
const CtaSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-[#228B22] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-[#228B22]/90 backdrop-blur-sm" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight text-white tracking-tight">
              {t.cta.title1} <span className="text-green-300">{t.cta.title2}</span>
            </h2>
            <p className="text-lg text-green-50/90 mb-8 max-w-lg leading-relaxed font-normal">
              {t.cta.desc}
            </p>
            ...
            <div className="mt-12 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100/90 text-sm mt-1">Get your personalized quote quickly and easily.</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center shrink-0 border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-green-100/90 text-sm mt-1">We work around your schedule, not the other way around.</p>
                </div>
              </div>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              <a href="tel:714-473-1140" className="bg-white text-[#228B22] hover:bg-green-50 px-8 py-4 rounded-2xl font-bold text-lg transition-all flex items-center justify-center gap-3 shadow-xl w-full sm:w-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 focus:ring-2 focus:ring-[#228B22] outline-none"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 focus:ring-2 focus:ring-[#228B22] outline-none bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 focus:ring-2 focus:ring-[#228B22] outline-none resize-none"
                  placeholder={t.cta.messagePlaceholder}
                ></textarea>
              </div>
              
              <button type="submit" className="w-full bg-[#228B22] hover:bg-[#1c711c] text-white px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 mt-2">
